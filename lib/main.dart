...
class _SelectorFlow2State extends State<SelectorFlow2> {
  ...
  void _onLongPressStart(LongPressStartDetails details) {
    print('long press start received.');
  ...
  void _onSingleLongTapMoveUpdate(var details) {
    ...
    print(editingSelectionIndex.toString());
    setState(() {
  ...
  void _onSingleLongTapEnd(var details) {
    ...
    print('newsels len: ' + newsels.length.toString());
    setState(() {
      selections
        ..clear()
        ..addAll(newsels);
